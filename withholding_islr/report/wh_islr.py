...
class RepComprobanteIslr(models.AbstractModel):
    _name = 'report.withholding_islr.template_wh_islr'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        if data['form'].state == 'done':
            ...
            return {
                ...
                # 'code_code': code_code,
		'total_doc': total_doc,
                'model': self.env['report.withholding_islr.template_wh_islr'],
                'doc_model': self.env['report.withholding_islr.template_wh_islr'],
