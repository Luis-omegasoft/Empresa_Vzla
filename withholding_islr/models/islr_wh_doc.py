...
class IslrWhDoc(models.Model):
 ...
 #       vals[0]['code'] = code
    ...
    def get_reconciled_move(self):
        ...
        if obj_move_line:
            raise UserError("El Comprobante ya tiene una aplicacion en la factura %s, debe desconciliar el comprobante para poder cancelar" % (iwdi_brw.invoice_id.number))
        else:
            return True
